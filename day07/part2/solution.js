...
function isFiveOfAKind(cardCounter) {
  let JOccurence = cardCounter.hasOwnProperty("J") ? cardCounter["J"] : 0;
  let highestOccurence = 0;
  for (let card in cardCounter) {
    if (card !== "J") {
      if (cardCounter[card] >= highestOccurence) {
        highestOccurence = cardCounter[card];
      }
    }
  }
  if (highestOccurence + JOccurence === 5) return true;
  return false;
}
...
function isFourOfAKind(cardCounter) {
  ...
  if (highestOccurence + JOccurence === 4) return true;
  return false;
}
...
function isFullHouse(cardCounter) {
  ...
  if (twoCard === 2 && JOccurence === 1) return true;
  if (treeCard === 1 && JOccurence === 1) return true;
  if (treeCard === 1 && JOccurence === 2) return true;
  if (twoCard === 1 && JOccurence === 2) return true;
  return false;
}
...
function isThreeOfAKind(cardCounter) {
  ...
  if (highestOccurence + JOccurence === 3) return true;
  return false;
}
...
function isTwoPairs(cardCounter) {
  ...
  if (twoCard === 2) return true;
  if (twoCard === 1 && JOccurence === 1) return true;
  if (twoCard === 0 && JOccurence === 2) return true;
  return false;
}
...
function isOnePair(cardCounter) {
  ...
  if (highestOccurence + JOccurence === 2) return true;
  return false;
}
...
function testMain() {
  let parsedHandOne = { A: 1, K: 1, Q: 1, T: 1, J: 1 };
  console.log(isFiveOfAKind(parsedHandOne));
  console.log(isFourOfAKind(parsedHandOne));
  console.log(isFullHouse(parsedHandOne));
  console.log(isThreeOfAKind(parsedHandOne));
  console.log(isTwoPairs(parsedHandOne));
  console.log(isOnePair(parsedHandOne));
}
// testMain();

// Total Winnings:  252681835 => Incorrect
